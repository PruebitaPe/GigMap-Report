...
<table>
  ...
  <b>Capítulo II: Requirements Elicitation & Analysis</b><br>
  - 2.1. Competidores<br>
  ...
  - 4.4. Mobile Applications UX/UI Design<br>
  - 4.4.1. Mobile Applications Wireframes<br>
  - 4.4.2. Mobile Applications Wireflow Diagrams<br>
  - 4.4.3. Mobile Applications Mock-ups<br>
  - 4.4.4. Mobile Applications User Flow Diagrams<br>
  - 4.5. Mobile Applications Prototyping<br>
  - 4.5.1. Android Mobile Applications Prototyping<br>
  - 4.5.2. iOS Mobile Applications Prototyping<br>
  - 4.6. Web Applications UX/UI Design<br>
  - 4.6.1. Web Applications Wireframes<br>
  - 4.6.2. Web Applications Wireflow Diagrams<br>
  - 4.6.3. Web Applications Mock-ups<br>
  - 4.6.4. Web Applications User Flow Diagrams<br>
  - 4.7. Web Applications Prototyping<br>
  - 4.8. Domain-Driven Software Architecture<br>
  - 4.8.1. Software Architecture Context Diagram<br>
  - 4.8.2. Software Architecture Container Diagrams<br>
  - 4.8.3. Software Architecture Components Diagrams<br>
  - 4.9. Software Object-Oriented Design<br>
  - 4.9.1. Class Diagrams<br>
  - 4.9.2. Class Dictionary<br>
  - 4.10. Database Design<br>
  - 4.10.1. Relational/Non-Relational Database Diagram<br><br>
  <b>Capítulo V: Product Implementation</b><br>
  ...
  - 5.2.7. RESTful API documentation<br>
  - 5.2.8. Team Collaboration Insights<br>
  - 5.3. Video About-the-Product
	...
	8.3.3.3. Implemented To-Be Native-Mobile Application Evidence<br>
	8.3.3.4. Implemented To-Be RESTful API and/or Serverless Backend Evidence<br>
	8.3.3.5. Team Collaboration Insights<br>
  ...
  <tbody>
    <tr>
      ...
      <td>
		...
		TF: <br>
Desarrolló la historia de usuario US36, orientada a que los fans puedan seguir y dejar de seguir artistas dentro de GigMap, además de visualizar actualizaciones relacionadas con nuevos eventos, publicaciones y cambios de fechas. Asimismo, elaboró la tarea técnica TS-25, definiendo los endpoints necesarios para gestionar las operaciones de seguimiento y dejar de seguir artistas mediante el backend, incluyendo la actualización del contador de seguidores. Además, participó en el diseño de las entrevistas de validación To-Be para los segmentos de fans de la música y artistas emergentes, estableciendo preguntas orientadas a evaluar la comprensión, utilidad y facilidad de uso de las nuevas funcionalidades implementadas. Su trabajo evidenció responsabilidad ética y profesional al asegurar la trazabilidad entre las necesidades de los usuarios, la implementación técnica y la validación directa con los segmentos objetivo. <br><br>
		...
		TF: <br>
Desarrolló las secciones 8.2. Experiment Design correspondientes a 8.2.1. Hypotheses, 8.2.3. Measures y 8.2.4. Conditions, definiendo de manera clara y estructurada las hipótesis a validar, las medidas necesarias para evaluar los resultados y las condiciones bajo las cuales se ejecutarían los experimentos. Su trabajo evidenció responsabilidad ética y profesional al garantizar que el diseño experimental fuera riguroso, transparente y estuviera correctamente fundamentado antes de su aplicación con los usuarios. <br><br>
...
Se encargó de la elaboración y consolidación de la sección Experiment Aftermath & Analysis, incluyendo el análisis e interpretación de los resultados obtenidos mediante el formulario de validación aplicado a fans de la música y artistas emergentes. Organizó las evidencias estadísticas, interpretó los resultados de cada funcionalidad y desarrolló el Re-scored and Re-prioritized Question Backlog. Su trabajo evidenció responsabilidad ética y profesional al presentar los resultados de manera transparente, reconocer las limitaciones de la muestra y evitar afirmar como comprobados aquellos incrementos que todavía requieren datos longitudinales de analítica. <br><br>
		...
		TF:  <br>Durante el desarrollo del Shareback Session Artifacts: Learning Workflow, participé de manera responsable compartiendo los hallazgos obtenidos, escuchando la retroalimentación de mis compañeros y respetando las opiniones del equipo. Esto permitió mejorar los artefactos del proyecto y asegurar que las decisiones tomadas fueran éticas, colaborativas y orientadas a las necesidades de los usuarios.<br>
      </td>
    ...
    <tr>
      ...
      <td>
		...
		TF: <br>
Evaluó el impacto de la funcionalidad de seguimiento de artistas en la conexión entre fans y músicos emergentes, considerando que esta característica permite a los usuarios mantenerse informados sobre nuevos eventos y publicaciones, mientras contribuye a mejorar la visibilidad de los artistas dentro de la plataforma. También analizó la necesidad de implementar endpoints de seguimiento y dejar de seguir de manera consistente, garantizando una experiencia confiable y una correcta actualización del número de seguidores. Asimismo, mediante el diseño de las entrevistas de validación To-Be, formuló preguntas que permitieron recoger evidencia sobre la utilidad real de las funcionalidades para fans y artistas. A partir de ello, contribuyó a tomar decisiones informadas sobre el valor social, cultural y tecnológico de GigMap dentro del ecosistema musical. <br><br>
        Collantes Carrillo, Diego Mateo <br><br>
		...
		TF: <br>
Emitió juicios informados al desarrollar las secciones de Hypotheses, Measures y Conditions dentro de Experiment Design, evaluando cómo cada hipótesis planteada y las medidas seleccionadas permitirían obtener evidencia confiable sobre el comportamiento real de los usuarios. Consideró el contexto y las condiciones bajo las cuales debían ejecutarse los experimentos, asegurando que las decisiones derivadas de los resultados reflejaran un impacto social y tecnológico real para los fans y artistas emergentes dentro del ecosistema musical. <br><br>
        Ortiz Cardenas, Johanna Antuanete <br><br>
...
| ----------------- | --------------------------------------- | ----------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | -------------- | ---------- |
| **US02**          | Publicar nuevo concierto                | **TSK01**   | Creación de concierto              | Como artista, quiero crear un concierto para promocionar mi presentación.                                                                           | 4 horas        | Ariana         | Done       |
...
| **TS04**          | Obtener todos los conciertos            | **TSK09**   | API GET de conciertos públicos     | Como developer, quiero un endpoint GET en /api/v1/concerts que devuelva todos los conciertos públicos para mostrarlos en la sección de exploración. | 4 horas        | Antuanete      | Done       |
| **TS10**          | Obtener concierto por ID                | **TSK10**   | API GET por ID                     | Como developer, quiero un endpoint GET en /api/v1/concerts/{concertId} que devuelva los datos de un concierto específico.                           | 3 horas        | Ariana         | Done       |

**Sprint Backlog 2:**

| **User Story ID** |            **Título (User Story)**            | **Task ID** |                    **Título (Task)**                     | **Descripción**                                                                                                                                                                                    | **Estimación (SP)** | **Asignado a** | **Estado** |
| :---------------: | :-------------------------------------------: | :---------: | :------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------------: | :------------: | :--------: |
|       US01        |      Filtrar eventos por género musical       |    TK-01    |        Implementar filtros de búsqueda por género        | Como fan, quiero filtrar eventos por género, para ver solo los que me interesan.                                                                                                                   |          3          |    Loreley     |    DONE    |
|       US03        |        Personalizar perfil de artista         |    TK-04    |         Habilitar edición de perfil (Avatar/Bio)         | Como artista, quiero personalizar mi perfil con mi nombre artístico y fotografía para conectar mejor con el público.                                                                               |          2          |     Diego      |    DONE    |
...
|       US06        |         Ver mapa con geolocalización          |    TK-07    |      Integración de API de Mapas y Geolocalización       | Como fan, quiero ver un mapa con mi ubicación y los conciertos cercanos marcados para explorar visualmente las opciones.                                                                           |          5          |     Ariana     |    DONE    |
|       US12        |           Ver estado del concierto            |    TK-14    |      Visualización de status (Disponible/Sold out)       | Como usuario, quiero saber si un concierto está disponible o agotado para decidir si puedo asistir.                                                                                                |          2          |     Renato     |    DONE    |
|       US14        |            Unirse a una comunidad             |    TK-01    |         Implementar lógica de unión a comunidad          | Como fan, quiero unirme a una comunidad musical para interactuar con otros usuarios con intereses similares.                                                                                       |          3          |     Álvaro     |    Done    |
|       US15        |           Publicar en la comunidad            |    TK-02    |     Desarrollo de funcionalidad de creación de posts     | Como fan, quiero crear publicaciones en la comunidad a la que me he unido, para compartir opiniones, fotos o recomendaciones con otros miembros.                                                   |          3          |    Loreley     |    Done    |
|       US16        |            Editar perfil personal             |    TK-03    |       Implementar edición de perfil (datos y foto)       | Como fan, quiero poder editar mi información de perfil (foto, nombre y nombre de usuario), para que los demás usuarios puedan reconocerme fácilmente y mantener mi perfil actualizado.             |          2          |     Diego      |    Done    |
|       US17        | Confirmar o marcar asistencia a un concierto  |    TK-04    |       Desarrollo de toggle de asistencia a evento        | Como fan, quiero poder marcar un concierto como “Marcar asistencia”, para llevar un seguimiento de los conciertos que planeo asistir.                                                              |          3          |   Antuanete    |    Done    |
|       US18        |           Ver comunidades accedidas           |    TK-05    |         Frontend: Mostrar lista de grupos unidos         | Como usuario, quiero visualizar en el apartado "Tus grupos" las comunidades a las que me he unido.                                                                                                 |          2          |     Ariana     |    Done    |
|       US19        |   Reaccionar a publicaciones en comunidades   |    TK-06    |      Implementar reacciones (likes/emojis) a posts       | Como usuario, quiero poder reaccionar a publicaciones dentro de las comunidades.                                                                                                                   |          2          |     Renato     |    Done    |
|       US20        |      Acceder a perfil de otros usuarios       |    TK-07    |         Implementar navegación a perfil público          | Como usuario, quiero poder acceder al perfil de otros usuarios para conocer más sobre ellos.                                                                                                       |          2          |    Loreley     |    Done    |
|       US21        |          Ver publicaciones con like           |    TK-08    |      Desarrollo de vista de publicaciones favoritas      | Como usuario, quiero ver una lista de publicaciones a las que les he dado "like".                                                                                                                  |          2          |     Álvaro     |    Done    |
|       US23        |         Subir imágenes en comunidades         |    TK-09    |       Implementación de carga de imágenes en posts       | Como usuario, quiero subir imágenes en publicaciones de comunidad para compartir experiencias visuales.                                                                                            |          3          |     Ariana     |    Done    |
|       US24        |             Ver eventos asociados             |    TK-10    |   Lógica de filtrado geo-temporal de eventos asociados   | Como usuario de GigMap, quiero ver un apartado de eventos relacionados en el perfil de un concierto, para conocer actividades cercanas en tiempo y lugar (afterparty/reunion) que podría realizar. |          3          |     Renato     |    Done    |
|       US26        |  Visualizar el contenido de las comunidades   |    TK-11    |           Frontend: Feed de "Mis comunidades"            | Como usuario, quiero poder visualizar las publicaciones y anuncios de las comunidades existentes para poder enterarme de distintos temas, en la pantalla de “Home”.                                |          2          |   Antuanete    |    Done    |
|       US27        | Recibir recordatorio de concierto por asistir |    TK-12    | Implementar servicio de notificaciones programadas (24h) | Como usuario, quiero recibir la notificación de recordatorio del concierto al que confirme mi asistencia cuando la fecha de presentación esté cercana.                                             |          5          |     Diego      |    Done    |
|       US30        | Ver información detallada del evento asociado |    TK-13    |      Frontend: Vista de detalle de evento asociado       | Como fan, quiero ver la información completa de un concierto para decidir si asistir.                                                                                                              |          2          |    Loreley     |    Done    |
...
Enlace de la Encuesta: https://forms.gle/3RRN4M6Mqir6q72W6
